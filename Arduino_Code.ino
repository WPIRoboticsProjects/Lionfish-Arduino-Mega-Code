...
#define SOSPIN 22 // SOS connected to digital pin 22
...
static const uint8_t ledPin = 13; // Set LED
...
// Receive Sonar Distance and Confidence Data
void loop()
{
...
// Battery Data
  ...
  Serial.println(Batt_V);          // Send Voltage
  Serial.println(Batt_A);          // Send Current
